const translations = {
  ...
  kz: {
    ...
    aboutUs: "Біз туралы",
    aboutText: `Біздің әңгімеміз уақыт өте келе одан да көп нәрсеге айналған достықтан басталды. Біз күлдік, бір-бірімізді қолдадық және қашықтықтан да, қиындықтан да қорықпайтын команда болдық. Біз махаббат тек сезім ғана емес, сонымен қатар күнделікті таңдау болады деп сенеміз. Біз бір-бірімізді мәңгілікке таңдадық. ❤️`,
    venue: "Өтетін орны",
    venueText: "Біз бұл ерекше күнді жүрекке ең қымбат адамдармен бөлісуді асыға күтеміз...",
